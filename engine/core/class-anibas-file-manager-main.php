		...
		if ('anibas-file-manager' === $page) {
			...
			wp_localize_script(
				...
				array(
					...
					'editorMaxBytes'      => (int) ANIBAS_FM_EDITOR_MAX_BYTES,
			...
			wp_localize_script(
				...
				array(
					...
					'chunkSizeMin'   => (int) ANIBAS_FM_CHUNK_SIZE_MIN,
					'chunkSizeMax'   => (int) ANIBAS_FM_CHUNK_SIZE_MAX,
					'chunkSizeStep'  => 1048576,
					'fileListPageSize' => (int) min(500, max(1, (int) ANIBAS_FILE_MANAGER_DEFAULT_FILELIST_PAGE_SIZE)),
					'uploadTokenExpiry' => (int) ANIBAS_FM_UPLOAD_TOKEN_EXPIRY,
					'trashMaxAgeDays' => (int) ceil(ANIBAS_FM_TRASH_MAX_AGE / DAY_IN_SECONDS),
					'backupMaxAgeDays' => (int) ceil(ANIBAS_FM_BACKUP_MAX_AGE / DAY_IN_SECONDS),
					'fileBackupKeep' => (int) ANIBAS_FM_FILE_BACKUP_KEEP,
